...
| `validate` | no findings above INFO | WARN findings, or some instances skipped | ERROR findings | cannot resolve `CATALINA_BASE`, `server.xml` missing or unparseable, `--all` with `--catalina-base`, or every instance skipped |
